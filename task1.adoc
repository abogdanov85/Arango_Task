...
// with variables for pages and links to them and other predefined entities
...
. _Mary bought a book._
. _Mary is friend of John._
...
It has three nodes for concepts (_Mary_, _John_, _a book_) and two edges for relationships between concepts (_bought_ and _is friend to_).



== How GraphRAG Differs from Traditional RAG

// I'm using One Sentence per Line method 
// See: https://nick.groenen.me/notes/one-sentence-per-line/
Traditional *RAG* systems typically rely on vector similarity search over document chunks.
While effective for simple lookup, they treat documents as isolated pieces of text.
...
// Here for the purpose of demonstration I make a direct include to your content source file
include::https://raw.githubusercontent.com/arangodb/docs-hugo/refs/heads/main/site/content/ai-suite/graphrag/technical-overview.md[lines=133..134]
